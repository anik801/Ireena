...
public class Level2 extends JPanel implements ActionListener,Runnable{
	Ireena p;
	...
	int kX,kY;
	public static int health,lives;
	boolean lost =false;
	...
	public static boolean initLevel2 =true;
	...
	public void initComponents(){
		...
		initLevel2=false;
		if(Level3.initLevel3){
			 ob= new Level3();
		}
		
		//initializing images
		bg1=new ImageIcon("src/zJava/w4.png").getImage();
	...
	public void makeDefault(){
		p.lives=Level1.lives;
		p.health=Level1.health;
		p.dx=0;
		p.dy=0;
		p.x=100;
		p.y=200;
	...
	public void paint(Graphics g){
		...
		g2d.drawString("Level 02", 500, 50);
		printHealth();
		...
		if(MainClass.score2<0)
			MainClass.score2=0;
		line=String.valueOf(MainClass.score2);
		g2d.setColor(Color.WHITE);
		...
		if(p.x>=endX-900){
			...
			if(p.x>=endX+100){
				...
				MainClass.score3=MainClass.score2;
				endLevel();			
			}			
		}
	...
	public void endLevel(){		
		...
		if(levelComplete==true){
			...
			MainClass.BOARD_3.setVisible(false);
			Level3.MD=true;
			MainClass.BOARD_4.add(ob);
			MainClass.BOARD_4.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			MainClass.BOARD_4.setSize(800,350);
			MainClass.BOARD_4.setResizable(false);
			MainClass.BOARD_4.setVisible(true);
			MainClass.BOARD_4.setLocationRelativeTo(null);
			MainClass.BOARD_3.disable();
			MainClass.BOARD_4.enable();
